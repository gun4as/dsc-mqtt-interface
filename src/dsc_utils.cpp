...
DSCkeybus->set_accessCode(accessCode);
DSCkeybus->set_maxZones(maxZonesDefault);
DSCkeybus->set_defaultPartition(defaultPartition);
DSCkeybus->set_debug(Ddebug);
DSCkeybus->set_expanderAddr(expanderAddr1, 0); // ja nepieciešams
DSCkeybus->set_expanderAddr(expanderAddr2, 0); // ja nepieciešams
