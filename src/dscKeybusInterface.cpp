...
byte dscKeybusInterface::dscWritePin = 0;
...
byte dscKeybusInterface::moduleIdx = 0;
bool dscKeybusInterface::enableModuleSupervision = false;
byte dscKeybusInterface::maxFields05 = 0;
byte dscKeybusInterface::maxFields11 = 0;
writeQueueType dscKeybusInterface::writeQueue[writeQueueSize] = {};
Stream* dscKeybusInterface::stream = nullptr;
byte* dscKeybusInterface::writeBuffer = nullptr;
byte dscKeybusInterface::cmdD0buffer[6] = {};
bool dscKeybusInterface::pendingD0 = false;
bool dscKeybusInterface::pending70 = false;
bool dscKeybusInterface::pending6E = false;
volatile byte dscKeybusInterface::writePartition = 0;
volatile byte dscKeybusInterface::writeBufferIdx = 0;
volatile byte dscKeybusInterface::writeBufferLength = 0;
volatile bool dscKeybusInterface::writeDataPending = false;
byte dscKeybusInterface::writeDataBit = 0;
volatile pgmBufferType dscKeybusInterface::pgmBuffer = {};
volatile byte dscKeybusInterface::inIdx = 0;
volatile byte dscKeybusInterface::outIdx = 0;
byte dscKeybusInterface::maxZones = 0;
byte dscKeybusInterface::panelVersion = 0;
